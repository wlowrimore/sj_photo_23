    ...
    <>
      <main className=''>
        ...
        {modalOpen && (
          ...
          <div className='w-screen h-screen fixed top-0 left-0 z-1000 bg-black/60 backdrop-blur-sm flex flex-col justify-center items-center px-auto' onClick={closeModal}>
